...
const createGallery = images
  .map(   // ітерація по масиву images
    ({ url, alt }) =>
    `<li>
    <img src="${url}" alt="${alt}" />
    </li>`) //   отримуємо значення властивостей url і alt з кожного об'єкта у масиві через деструктуризацію. За допомогою шаблонного рядку формуємо розмітку кожного зображення у вигляді рядка HTML
